...
public class test {
    ...
    */
    ...
    public void tearDown() {
        ...
        @Test
    public void testID() {
        assertEquals("Alumno_OK", b.checkID(2,"al608780"));
       assertEquals("Alumno_OK", b.checkID(2,"al011120"));
    ...
    public void testID2() {
       ...
       assertEquals("ERROR02", idMaestroAlumno.checkID(2,"al1671119"));
           ...
           @Test
    public void testID3() {
        assertEquals("Intendencia_OK", b.checkID(3,"in000"));
       assertEquals("Intendencia_OK", b.checkID(3,"in123"));
       assertEquals("ERROR03", b.checkID(3,"1001"));
       assertEquals("ERROR03", b.checkID(3,"in1002"));
    }  
